...
export default function CTAFinal() {
    return (
        <section
            id="contacto"
            className="relative overflow-hidden bg-gradient-to-br from-[#FFDE59] via-[#F7B52A] to-[#FFDE59] px-6 py-24 text-gray-900"
        >
                ...
                <ScrollReveal delay={200}>
                    <div className="flex flex-col items-center gap-4 sm:flex-row sm:justify-center">
                        ...
                        <a
                            ...
                            className="flex items-center gap-2 rounded-full border-2 border-gray-900/30 px-8 py-5 text-lg font-semibold transition-all duration-300 hover:border-gray-900 hover:bg-gray-900/10"
                        >
